...
class _EditFoodMenuState extends State<EditFoodMenu> {
  ...
  Future<Null> editValueOnMySQL() async {
    ...
    String url =
        '${MyConstant().domain}/bengfood/editFoodWhereId.php?isAdd=true&id=$id&NameFood=$name&PathImage=$pathImage&Price=$price&Detail=$detail';
